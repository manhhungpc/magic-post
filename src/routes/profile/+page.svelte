	...
	<div class="md:w-[50%] w-[80%] m-auto flex flex-col items-center">
		...
		<div class="md:flex w-full justify-between block">
			...
			<div class="md:w-[48%] w-full">
				...
				<input type="text" value="Mã nhân viên" class="dui-input dui-input-bordered h-10 rounded-md w-full" disabled/>
			</div>
		</div>
		<div class="w-full">
			<label class="mt-3" for="position">Chức vụ:</label>
			<input type="text" value="Chức vụ" class="dui-input dui-input-bordered h-10 rounded-md w-full" disabled/>
		</div>
		<div class="md:flex w-full justify-between block">
			<div class="md:w-[48%] w-full">
